    ...
    internal class BottomPanelDrawService
    {
        ...
        public void Draw(Graphics g, XCMapTile mapTile, XCMapTile.MapQuadrant selectedQuadrant)
        {
            ...
            if (selectedQuadrant == XCMapTile.MapQuadrant.Ground)
                ...
                g.FillRectangle(Brush, startX + (TOTAL_QUADRAN_SPACE), startY, tileWidth + 1, tileHeight + 2);
            else if (selectedQuadrant == XCMapTile.MapQuadrant.North)
                g.FillRectangle(Brush, startX + (2 * TOTAL_QUADRAN_SPACE), startY, tileWidth + 1,
                    tileHeight + 2);
            else if (selectedQuadrant == XCMapTile.MapQuadrant.Content)
                g.FillRectangle(Brush, startX + (3 * TOTAL_QUADRAN_SPACE), startY, tileWidth + 1,
                    tileHeight + 2);
            ...
            {
                g.DrawImage(mapTile.Ground[MapViewPanel.Current].Image, startX,
                    startY - mapTile.Ground.Info.TileOffset);
                if (mapTile.Ground.Info.HumanDoor || mapTile.Ground.Info.UFODoor)
                    g.DrawString("Door", Font, System.Drawing.Brushes.Black, startX,
            ...
            {
                g.DrawImage(mapTile.West[MapViewPanel.Current].Image, startX + (TOTAL_QUADRAN_SPACE),
                    startY - mapTile.West.Info.TileOffset);
                if (mapTile.West.Info.HumanDoor || mapTile.West.Info.UFODoor)
                    g.DrawString("Door", Font, System.Drawing.Brushes.Black, startX + (TOTAL_QUADRAN_SPACE),
                        startY + PckImage.Height - Font.Height);
            }
            else
            ...
            {
                g.DrawImage(mapTile.North[MapViewPanel.Current].Image, startX + (2 * TOTAL_QUADRAN_SPACE),
                    startY - mapTile.North.Info.TileOffset);
                if (mapTile.North.Info.HumanDoor || mapTile.North.Info.UFODoor)
                    g.DrawString("Door", Font, System.Drawing.Brushes.Black, startX + (2 * TOTAL_QUADRAN_SPACE),
                        startY + PckImage.Height - Font.Height);
            }
            else
            ...
            {
                g.DrawImage(mapTile.Content[MapViewPanel.Current].Image, startX + (3 * TOTAL_QUADRAN_SPACE),
                    startY - mapTile.Content.Info.TileOffset);
                if (mapTile.Content.Info.HumanDoor || mapTile.Content.Info.UFODoor)
                    g.DrawString("Door", Font, System.Drawing.Brushes.Black, startX + (3 * TOTAL_QUADRAN_SPACE),
                        startY + PckImage.Height - Font.Height);
            }
            else
            ...
            g.DrawString("West", Font, System.Drawing.Brushes.Black,
                new RectangleF(startX + (TOTAL_QUADRAN_SPACE), startY + tileHeight + space, tileWidth, 50));
            g.DrawString("North", Font, System.Drawing.Brushes.Black,
                new RectangleF(startX + (2 * TOTAL_QUADRAN_SPACE), startY + tileHeight + space, tileWidth, 50));
            g.DrawString("Content", Font, System.Drawing.Brushes.Black,
                new RectangleF(startX + (3 * TOTAL_QUADRAN_SPACE), startY + tileHeight + space, tileWidth + 50, 50));
